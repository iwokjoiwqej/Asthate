...
const state = {
  ...
  months: [
    { name: "2026 • Month 1", tag: "Illustrative", net: "+2.4%", dd: "−1.1%", notes: "Stable yield anchor + light quant exposure" },
    { name: "2026 • Month 2", tag: "Illustrative", net: "+1.7%", dd: "−0.8%", notes: "Regime filter reduced churn; fees optimized" },
    { name: "2026 • Month 3", tag: "Illustrative", net: "+3.1%", dd: "−1.6%", notes: "Momentum basket performed; risk caps respected" },
  ],
};
